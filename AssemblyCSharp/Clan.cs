			...
			for (int i = 0; i < array.Length; i++)
			{
				...
				try
				{
					...
					case 0:
					{
						text2 = "c0" + text2;
						string text3 = text2;
						text2 = text3 + mResources.CLAN_ACTIVITY[1] + " " + NinjaUtil.numberToString(array2[2]) + " " + mResources.CLAN_ACTIVITY[0] + " " + array2[3];
						break;
					}
					case 1:
					{
						text2 = "c1" + text2;
						string text3 = text2;
						text2 = text3 + " " + mResources.CLAN_ACTIVITY[2] + " " + NinjaUtil.numberToString(array2[2]) + " " + mResources.CLAN_ACTIVITY[0] + " " + array2[3];
						break;
					}
					case 2:
					{
						text2 = "c2" + text2;
						string text3 = text2;
						text2 = text3 + " " + mResources.CLAN_ACTIVITY[3] + " " + NinjaUtil.numberToString(array2[2]) + " " + mResources.CLAN_ACTIVITY[0] + " " + array2[3];
						break;
					}
					case 3:
					{
						text2 = "c1" + text2;
						string text3 = text2;
						text2 = text3 + " " + mResources.CLAN_ACTIVITY[4] + " " + NinjaUtil.numberToString(array2[2]) + " " + mResources.CLAN_ACTIVITY[0] + " " + array2[3];
						break;
					}
					case 4:
					{
						text2 = "c1" + text2;
						string text3 = text2;
						text2 = text3 + mResources.CLAN_ACTIVITY[5] + " " + NinjaUtil.numberToString(array2[2]) + " " + mResources.CLAN_ACTIVITY[0] + " " + array2[3];
						break;
					}
					case 5:
					{
